...
public class OfferStore extends AppCompatActivity {
    private storeOfferAdapter offersAdapter;
...
//        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#000080")));
        ...
        pDialog = new ProgressDialog(OfferStore.this);
        ...
        if (prefs.getString("currentEvent", "No Event Selected").equalsIgnoreCase("No Event Selected")) {
            Intent intent = new Intent(OfferStore.this, EventChooserActivity.class);
        ...
        offersAdapter = new storeOfferAdapter(this, kEventId);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> scheduleAdapter, View myView, int myItemInt, long mylng) {
                ...
                Intent showOfferDetail = new Intent(OfferStore.this, storeoffer_detail.class);
                showOfferDetail.putExtra("objectId", selectedFromList.getObjectId().toString());
                ...
                showOfferDetail.putExtra("cost", selectedFromList.getInt("cost"));
...
//                Intent intent = new Intent(OfferStore.this, DispatchActivity.class);
...
//    }
    private void setToolbar() {
        ...
        SharedPreferences prefs = this.getSharedPreferences(
                "com.mobile.blooth", Context.MODE_PRIVATE);
        if (toolbar != null) {
            toolbar.setTitle("User Points" + " " + ParseUser.getCurrentUser().getInt("points"));
